        ...
        private void doActions()
        {
            try
            {
                ...
                try
                {
                    do
                    {
                        SmartServer.connect("82.204.220.34", 8090, "******", "robotrade"); /* connect to broker server */
                    }
                    ...
                    if (SmartServer.IsConnected()) // proceed once connected
                    {
                        ...
                        try
                        {
                            ...
                            try
                            {
                                // ODBC is needed for dumping data into MS Access document
                            ...
                            {
                                Console.WriteLine("\nodbc error occured. " + e.Message); Console.ReadKey();
                            }
